...
;; FIXME: Sometimes does not work as expected?
;; Sometimes does not allow me to insert a tab in insert mode.
...
(use-package autoinsert
  ...
  (setq auto-insert-mirror ".emacs.d/templates/")
  (setq auto-insert-directory (expand-file-name auto-insert-mirror "~"))
...
(use-package yasnippet
  ...
  ;; Fetch snippets from github mirror
  (let ((snippets ["class" "constructor" "destructor" "function" "header"]))
    (github-mirror-download "snippets/c++-mode/" snippets))
  )
